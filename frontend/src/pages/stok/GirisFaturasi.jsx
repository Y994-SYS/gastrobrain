                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="0.00"
                                                className={`w-full bg-zinc-700 border rounded-lg px-3 py-2 text-sm outline-none focus:border-lime-400 text-white ${fiyatFarkli ? 'border-amber-500/50' : 'border-zinc-600'
                                                    }`}
                                            />
                                        </div>
                                        <div>
