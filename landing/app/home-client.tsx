...
const sorular = [
    ...
    { soru: 'Destek nasıl alırım?', cevap: 'Email ve WhatsApp desteği sunuyoruz. Profesyonel planda öncelikli destek sağlanmaktadır.' },
...
export default function HomeClient() {
    ...
    return (
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-stat-note { font-size: 0.7rem; color: #52525b; margin-top: 1.5rem; }
        ...
        /* Dürüst sosyal kanıt / erken erişim şeridi */
        .early-strip { background: #18181b; border: 1px solid #27272a; border-radius: 16px; padding: 2rem; max-width: 900px; margin: 0 auto; text-align: center; }
        .early-strip h3 { font-size: 1.05rem; font-weight: 800; color: #fff; margin-bottom: 0.5rem; }
        .early-strip p { color: #71717a; font-size: 0.9rem; line-height: 1.6; max-width: 560px; margin: 0 auto 1.25rem; }
        .early-badges { display: flex; gap: 0.75rem; justify-content: center; flex-wrap: wrap; }
        .early-badge { font-size: 0.75rem; color: #a1a1aa; background: #09090b; border: 1px solid #27272a; padding: 0.4rem 0.9rem; border-radius: 999px; }
        ...
        /* SEO içerik bloğu */
        .seo-block { max-width: 780px; margin: 0 auto; color: #71717a; font-size: 0.875rem; line-height: 1.8; }
        ...
        .contact-btn.whatsapp { background: #22c55e1a; color: #22c55e; border: 1px solid #22c55e4d; }
        .contact-btn.whatsapp:hover { background: #22c55e33; }
            ...
            <main style={{ background: '#09090b', color: '#fff', minHeight: '100vh', fontFamily: 'system-ui,-apple-system,sans-serif' }}>
                ...
                <div className="hero">
                    ...
                    <div className="hero-stats">
                        {[
                            ...
                            { sayi: '5 dk', etiket: 'Ortalama kurulum süresi' },
                            { sayi: '7/24', etiket: 'Sistem erişimi' },
                        ].map(s => (
                            <div key={s.etiket}>
                ...
                <section style={{ paddingTop: '3rem', paddingBottom: '3rem' }}>
                    <div className="early-strip">
                        ...
                        <p>
                            GastroBrain, gerçek restoran işletmecileriyle birlikte şekilleniyor.
                            İlk kullanıcılarımıza kurulum desteği ve öncelikli özellik talebi hakkı tanıyoruz.
                        </p>
                        <div className="early-badges">
                            <span className="early-badge">🧑‍🍳 Restoran sahipleriyle birlikte geliştiriliyor</span>
                            <span className="early-badge">⚡ Kurulumu biz üstleniyoruz</span>
                            <span className="early-badge">💬 Doğrudan geliştiriciyle destek</span>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <div className="seo-block">
                        ...
                        <p>
                            GastroBrain, restoran ve kafe işletmecileri için geliştirilmiş bir stok takip ve
                            maliyet yönetim sistemidir. Giriş faturalarından zayi kayıtlarına kadar tüm stok
                            hareketlerini tek yerden takip edebilir, her reçetenin gerçek maliyetini otomatik
                            hesaplayabilirsiniz.
                        </p>
                        <p>
                            Tek şubeli işletmelerden çok şubeli restoran zincirlerine kadar ölçeklenen sistem;
                            şubeler arası transfer, merkez depo yönetimi ve planlı otomatik transfer gibi
                            özelliklerle stok ve maliyet kontrolünü kolaylaştırır.
                        </p>
                    </div>
                </section>
