...
const stokController = {
    ...
    async hareketleriGetir(req, res) {
        try {
            const data = await stokService.hareketleriGetir(req.query.stokKartId);
    ...
    async tumStokDurumu(req, res) {
        try {
            ...
            const data = await stokService.tumStokDurumu(subeId);
            res.json({ basarili: true, data });
        } catch (error) {
            res.status(500).json({ basarili: false, mesaj: error.message });
        }
    ...
    async mevcutStokGetir(req, res) {
        try {
            ...
            const miktar = await stokService.mevcutStokGetir(stokKartId, subeId);
    ...
    async girisFaturasiEkle(req, res) {
        try {
            const data = await stokService.girisFaturasiEkle(req.body);
    ...
    async iadeFaturasiEkle(req, res) {
        try {
            const data = await stokService.iadeFaturasiEkle(req.body);
            res.status(201).json({ basarili: true, data });
        } catch (error) {
            res.status(400).json({ basarili: false, mesaj: error.message });
        }
    ...
    async zayiEkle(req, res) {
        try {
            const data = await stokService.zayiEkle(req.body);
            res.status(201).json({ basarili: true, data });
        } catch (error) {
            res.status(400).json({ basarili: false, mesaj: error.message });
        }
    ...
    async tuketimEkle(req, res) {
        try {
            const data = await stokService.tuketimEkle(req.body);
            res.status(201).json({ basarili: true, data });
        } catch (error) {
            res.status(400).json({ basarili: false, mesaj: error.message });
        }
    ...
    async aySonuSayimEkle(req, res) {
        try {
            const data = await stokService.aySonuSayimEkle(req.body);
            res.status(201).json({ basarili: true, data });
        } catch (error) {
            res.status(400).json({ basarili: false, mesaj: error.message });
        }
